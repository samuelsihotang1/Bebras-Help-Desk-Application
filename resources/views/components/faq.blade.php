    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="add-faqModalLabel">Add question</h5>
        </div>
          ...
          <div class="row mt-3">
            <div class="col-sm-12">
              <input type="text" name="title" class="form-control"
                placeholder="Start your question with 'What', 'How', 'Why', etc." autocomplete="off" id="q-title">
