        ...
        <div class="row">
          <div class="col-12">
            <a href="{{ route('admin.questions.latest') }}"
              class="{{ request()->route()->named('admin.questions.latest') ? 'text-danger' : 'text-dark' }}">Latest</a>
          </div>
          <div class="col-12 mt-2">
            <a href="{{ route('admin.questions.most-reported') }}"
              class="{{ request()->route()->named('admin.questions.most-reported') ? 'text-danger' : 'text-dark' }}">Most
              Reported</a>
          </div>
        </div>
      </div>
