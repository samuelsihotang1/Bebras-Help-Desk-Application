  ...
  public function run()
  {
    ...
    for ($i = 1; $i <= 3; $i++) {
      DB::table('users')->insert([
        ...
        'avatar' => 'https://ui-avatars.com/api/?name=Biro' . $i . '&background=868e96&color=fff',
        'country' => 'Indonesia',
        'role' => 'admin',
        'marker' => 'biro',
        'approved' => 'true',
    ...
    for ($i = 1; $i <= 3; $i++) {
      DB::table('users')->insert([
        ...
        'avatar' => 'https://ui-avatars.com/api/?name=Guru' . $i . '&background=868e96&color=fff',
        'country' => 'Indonesia',
        'role' => 'user',
        'marker' => 'guru',
        'approved' => 'true',
    ...
    for ($i = 1; $i <= 3; $i++) {
      DB::table('users')->insert([
        ...
        'avatar' => 'https://ui-avatars.com/api/?name=Pusat' . $i . '&background=868e96&color=fff',
        'country' => 'Indonesia',
        'role' => 'admin',
        'marker' => 'pusat',
        'approved' => 'true',
