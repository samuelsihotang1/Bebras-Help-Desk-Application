    ...
    <div class="mb-4 sm:mx-auto sm:w-full sm:max-w-[480px]">
      <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
        <form class="space-y-6" action="{{ route('register') }}" method="POST">
          ...
          <div>
            <label for="password" class="block text-sm font-medium leading-6 text-gray-900 italic">Kata Sandi</label>
            <div class="mt-2">
      ...
      <div class="flex items-center h-full px-20 ">
        <div class="p-10 rounded-xl border border-white border-opacity-20 bg-white bg-opacity-50">
          ...
          <p class="text-xl font-bold text-gray-700 mt-3">
            Sambutannya telah ditunggu-tunggu: menjadi bagian dari Bebras Help Desk sekarang! Ayo daftar dan
            berkontribusi.
          </p>
        </div>
      </div>
