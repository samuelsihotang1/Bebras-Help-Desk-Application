        ...
        <div class="modal-header">
          <h5 class="modal-title" id="answerModalLabel">
            <img
              ...
              alt="avatar" class="rounded-circle mr-2" width="42px" height="42px">
            {{ Auth::user()->name }}
          </h5>
        </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <input type="file" name="image" accept="image/*" class="form-control mt-2"
                onchange="document.getElementById('output').src = window.URL.createObjectURL(this.files[0])" id="image">
