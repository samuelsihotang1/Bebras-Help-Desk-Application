        ...
        <div class="row">
          <div class="col-12">
            <a href="{{ route('admin.comments.latest') }}"
              class="{{ request()->route()->named('admin.comments.latest') ? 'text-danger' : 'text-dark' }}">Latest</a>
          </div>
          <div class="col-12 mt-2">
            <a href="{{ route('admin.comments.most-reported') }}"
              class="{{ request()->route()->named('admin.comments.most-reported') ? 'text-danger' : 'text-dark' }}">Most
              Reported</a>
          </div>
        </div>
      </div>
