      ...
      <div class="card-body">
        ...
        <div class="row">
          <a href="javascript:void(0)" class="text-danger font-weight-bold"
            style="background-color: rgba(255, 0, 0, 0.1); padding: 5px 10px; border-radius: 5px; display: inline-block; width: 100%;"
            onclick="makeRedBox(event)">
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-6">
                ...
                <a href="javascript:void(0)" class="text-dark">Ubah Kata Sandi</a>
                @else --}}
                <a href="" data-toggle="modal" data-target="#phoneModal">{{ auth()->user()->phone_number ?
                  'WA : ' . auth()->user()->phone_number : 'Tambah Nomor' }}</a>
                {{-- @endif --}}
              </div>
              <!-- Modal -->
              <form action="{{ route('settings.phone',auth()->id()) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal fade" id="phoneModal" aria-labelledby="phoneModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="phoneModalLabel">Ubah Nomor Handphone </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div class="modal-body">
                        <div class="row">
                          <div class="col-12">
                            <label for="">Nomor Handphone *628</label>
                            <input type="phone_number" name="phone_number" class="form-control">
                            @include('layouts.error', ['name' => 'phone_number'])
                          </div>
                        </div>
                      </div>
                      <div class="modal-footer">
        ...
        <div class="row">
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-6">
                <a href="javascript:void(0)">{{ auth()->user()->country ? auth()->user()->country : 'Pilih Negara '
                  }}</a>
              </div>
            </div>
          </div>
